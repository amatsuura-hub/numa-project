...
const HERO_NODES: Node[] = [
  ...
  },
  {
    ...
    data: {
      label: "HTTPサーバー",
      description: "net/httpでWebサーバー実装",
      depth: 2,
    },
  },
  {
...
const DEFAULT_EDGE_OPTIONS = {
  ...
  style: { stroke: "rgba(45,90,50,0.25)", strokeWidth: 1.5 },
  animated: true,
};
...
function HeroPreview() {
  ...
  return (
    <div className="w-full h-[480px] z-[1]">
      <ReactFlow
        nodes={HERO_NODES}
        edges={HERO_EDGES}
        nodeTypes={nodeTypes}
